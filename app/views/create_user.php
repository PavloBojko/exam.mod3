<?php
$this->layout('layout', ['title' => 'create_user']);
?>
                        ...
                        <div class="panel-content">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="example-select" name="status">
                                    ...
                                    ?>
                                        <option value='<?php echo $value['id'] ?>'><?php echo $value['name_status'] ?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
                        ...
                        <div class="panel-content">
                            <div class="row">
                                ...
                                <div class="col-md-12 mt-3 d-flex flex-row-reverse">
                                    <button class="btn btn-success" type="submit" value="create_user" name="output">Добавить</button>
                                </div>
                            </div>
                        </div>
                    </div>
