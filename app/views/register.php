                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 ml-auto mr-auto">
                            <div class="card p-4 rounded-plus bg-faded">
                                ...
                                echo flash()->display();
                                ?>
                                <form method="POST" id="js-login" novalidate="" action="/logic">
                                    ...
                                    <div class="row no-gutters">
                                        <div class="col-md-4 ml-auto text-right">
                                            <button id="js-login-btn" type="submit" class="btn btn-block btn-danger btn-lg mt-3" name="output" value="register">Регистрация</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
